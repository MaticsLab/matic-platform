 ...
 *
 * Generated types: ai-gateway, blob, clerk, database, fal, firecrawl, github, linear, matic-email, matic-review, perplexity, resend, slack, stripe, superagent, v0, webflow
 */
