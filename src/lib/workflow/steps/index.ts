...
// Matic Email steps
import type { sendEmailStep as maticSendEmailStep } from "../plugins/matic-email/steps/send-email";
import type { sendNotificationStep } from "../plugins/matic-email/steps/send-notification";
import type { sendToReviewersStep } from "../plugins/matic-email/steps/send-to-reviewers";

// Matic Review steps
import type { moveToStageStep } from "../plugins/matic-review/steps/move-to-stage";
import type { assignReviewersStep } from "../plugins/matic-review/steps/assign-reviewers";
import type { addTagsStep } from "../plugins/matic-review/steps/add-tags";
import type { removeTagsStep } from "../plugins/matic-review/steps/remove-tags";
import type { setStatusStep } from "../plugins/matic-review/steps/set-status";
import type { getApplicationStep } from "../plugins/matic-review/steps/get-application";
import type { checkScoreStep } from "../plugins/matic-review/steps/check-score";

// Resend steps
import type { sendEmailStep as resendSendEmailStep } from "../plugins/resend/steps/send-email";
